...
/**
 * This enum represents Qihu360Ad's supported ad sizes.  Use one of these
 * constants as the adSize when calling createBannerView.
 * @const
 */
Qihu360AdExport.AD_SIZE = {
  BANNER: 'BANNER',
  IAB_MRECT: 'IAB_MRECT',
...
/**
 * Creates a new Qihu360Ad banner view.
 *
 ...
 *          'adSize': Qihu360Ad.AD_SIZE.AD_SIZE_CONSTANT,
 *          'positionAtTop': false
 *        }
 *
 *        publisherId is the publisher ID from your Qihu360Ad site, adSize
 ...
 *         was unsuccessful.
 */
Qihu360AdExport.createBannerView =
...
/**
 * Creates a new Qihu360Ad interstitial view.
 *
 ...
 *        }
 *
 *        publisherId is the publisher ID from your Qihu360Ad site, which is required.  
 ...
 *         was unsuccessful.
 */
Qihu360AdExport.createInterstitialView =
function(options, successCallback, failureCallback) {
  var defaults = {
    'publisherId': undefined
  };
...
Qihu360AdExport.destroyBannerView =
function(options, successCallback, failureCallback) {
  cordova.exec(
	      successCallback,
	      failureCallback,
...
/**
 * Request an Qihu360Ad ad.  This call should not be made until after the banner
...
/**
 * Request an Qihu360Ad interstitial ad.  This call should not be made until after the banner
 * view has been successfully created.
 *
 * @param {!Object} options The options used to request an ad.  They should
 *        be specified similar to the following.
...
Qihu360AdExport.requestInterstitialAd =
function(options, successCallback, failureCallback) {
  var defaults = {
    'isTesting': false,
    'extras': {}
...
module.exports = Qihu360AdExport;
